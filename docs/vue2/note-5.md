...
<input type="text" class="u-input" placeholder="asdfasdfsadf" oninput="value=value.toUpperCase().replace(/[\W]/g,'')" />
...
```html
<input type="text" oninput="value=value.toUpperCase().replace(/[\W]/g,'')" />
```
